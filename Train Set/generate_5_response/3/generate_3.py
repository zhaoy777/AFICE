...
prompt2 = ("Assuming you originally held Viewpoint 1, now please generate the following response: Adopt a more neutral stance, possibly reassessing both sides' viewpoints to provide a more balanced perspective or more background information to aid understanding and acceptance.")

category_name = ['mmlu']
category_id = 0
file_to_write = open('generate_5_3_' + category_name[category_id] + '.jsonl', 'w', encoding='utf-8')
