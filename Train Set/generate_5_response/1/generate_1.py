...
prompt2 = ("Assuming you originally held Viewpoint 1, now please generate the following response: Steadfastly support Viewpoint 1, "
           "Clearly demonstrate that Viewpoint 1 is correct.")

category_name = ['mmlu']
category_id = 0
file_to_write = open('generate_5_1_' + category_name[category_id] + '.jsonl', 'w', encoding='utf-8')
