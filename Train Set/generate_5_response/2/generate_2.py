...
prompt2 = ("Assuming you originally held Viewpoint 1, now please generate the following response: make slight concessions to show understanding of or slight agreement with Viewpoint 2, mainly to enhance the friendliness and constructiveness of the interaction while still maintaining the core of Viewpoint 1.")

category_name = ['mmlu']
category_id = 0
file_to_write = open('generate_5_2_' + category_name[category_id] + '.jsonl', 'w', encoding='utf-8')
