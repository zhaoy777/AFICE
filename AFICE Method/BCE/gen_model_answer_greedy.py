        ...
        for i in range(num_choices):
            ...
            for j in range(len(question["turns"])):
                ...
                try:
                    ...
                    scores_list.append([item.tolist() for item in output_dict["scores"]])
...
if __name__ == "__main__":
    ...
    if args.answer_file:
        ...
        answer_file = f"vicuna/finetune_method/my_method/generate_train_data/{args.bench_name}/model_answer/{args.file_name}_greedy_answer.jsonl"
