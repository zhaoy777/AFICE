...
file_to_write = open('mmlu_semantic_entropy.jsonl', 'w', encoding='utf-8')
root_path = 'vicuna/finetune_method/my_method/generate_train_data/cluster/'
for file_name in file_name_list:
    answers = read_jsonl_to_dicts(root_path + file_name + '_semantic_entropy_answer.jsonl')
    for answer  in answers:
        ans_json = {
            "question_id": answer['question_id'] + index_bias[file_name],
            "semantic_entropy": answer['semantic_entropy'],
        }
